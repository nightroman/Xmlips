...
.Description
	The script downloads Xmlips.zip to the current location and extracts files
	to the new directory Xmlips. If these items exist remove them manually or
